...
class DetailTourismActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val detailTourism = intent.getParcelableExtra<com.dicoding.core.domain.model.Tourism>(EXTRA_DATA)
        showDetailTourism(detailTourism)
    }

    private fun showDetailTourism(detailTourism: com.dicoding.core.domain.model.Tourism?) {
        detailTourism?.let {
